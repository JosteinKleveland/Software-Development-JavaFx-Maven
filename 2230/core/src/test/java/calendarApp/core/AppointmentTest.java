...
public class AppointmentTest {
    ...
    @Test
    @DisplayName("Check that the appointmentDescription requirement is followed")
    public void checkAppointmentDescriptionTest() throws IllegalArgumentException {
        String moreThan250Char = "This is a test. how long should a descripotion be able to be? I have fotball on Sundays and Handball on Tuesdays. I must remember to bring my computer. this is a test. how long should a descripotion be able to be? I have fotball on Sundays and Handball on Tuesdays.";
        //Shall fail if description is longer than 250 characters
        assertThrows(IllegalArgumentException.class, () -> new Appointment("Fotball", moreThan250Char, DaysOfTheWeek.FRIDAY, 10, 11, 0, 0));
    }
